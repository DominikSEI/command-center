...
@router.post("/{project_id}/todos", response_model=TrackerTodoOut, status_code=status.HTTP_201_CREATED)
...
@router.patch("/{project_id}/todos/{todo_id}", response_model=TrackerTodoOut)
